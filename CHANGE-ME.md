...
**Where:** §1 CONFIG, line 145 (`playerStepsPerSecond`)
...
**Where:** §2 DATA, lines 338–343 (`items`)
...
**Where:** §2 DATA, lines 359–469 (`npcs`)
...
**Where:** §2 DATA, lines 359–469 (`npcs`)
**Where:** §3 STATE, lines 502–537 (`state`)
...
map row.
**Where:** §1 CONFIG, lines 168–189 (`colors`)
**Where:** §2 DATA, lines 240–249 (`tileTypes`)
**Where:** §2 DATA, lines 261–293 (`maps.overworld.rows`)
...
**Where:** §2 DATA, lines 258–315 (`maps`)
**Where:** §2 DATA, lines 261–293 (`maps.overworld.rows`)
**Where:** §2 DATA, lines 318–327 (`doors`)
...
**Where:** §2 DATA, lines 359–469 (`npcs`)
**Where:** §5 UPDATE, lines 747–762 (`updateTalking`)
**Where:** §5 UPDATE, lines 766–799 (`updateDialogue`)
**Where:** §5 UPDATE, lines 797–801 (`giveItemToNpc`)
