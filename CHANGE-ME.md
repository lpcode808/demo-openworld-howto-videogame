...
**Where:** §1 CONFIG, line 244 (`playerStepsPerSecond`)
...
**Where:** §2 DATA, lines 558–708 (`npcs`)
**Where:** §3 STATE, lines 741–787 (`state`)
**Where:** §5 UPDATE, lines 912–932 (`update`)
...
**Where:** §3 STATE, lines 763–768 (`state.flags`)
**Where:** §2 DATA, lines 540–545 (`quests`)
**Where:** §5 UPDATE, lines 912–932 (`update`)
**Where:** §7 RENDER, lines 1416–1478 (`drawHud`) and lines 1483–1497 (`drawQuestList`)
...
**Where:** §2 DATA, lines 558–708 (`npcs`) — the `lines:` arrays inside each `dialogue:` block
...
**Where:** §2 DATA, lines 401–489 (`maps`), lines 492–512 (`doors`), lines 523–533 (`items`),
lines 540–545 (`quests`), lines 558–708 (`npcs`); §6 COLLIDE for the new gate; §1 CONFIG for
