...
**Where:** §1 CONFIG, line 78 (`playerStepsPerSecond`)
...
**Where:** §1 CONFIG, lines 101–125 (`colors`)
...
**Where:** §2 DATA, lines 195–224 (`maps.overworld.rows`)
...
**Where:** §2 DATA, lines 271–276 (`items`)
...
**Where:** §2 DATA, lines 292–402 (`npcs`)
...
**Where:** §2 DATA, lines 292–402 (`npcs`)
**Where:** §3 STATE, lines 434–469 (`state`)
**Where:** §5 UPDATE, lines 560–571 (`update`)
...
map row.
**Where:** §1 CONFIG, lines 101–125 (`colors`)
**Where:** §2 DATA, lines 173–183 (`tileTypes`)
**Where:** §2 DATA, lines 195–224 (`maps.overworld.rows`)
...
**Where:** §2 DATA, lines 191–247 (`maps`)
**Where:** §2 DATA, lines 195–224 (`maps.overworld.rows`)
**Where:** §2 DATA, lines 251–260 (`doors`)
...
**Where:** §2 DATA, lines 280–284 (`quests`)
**Where:** §2 DATA, lines 292–402 (`npcs`)
**Where:** §5 UPDATE, lines 679–694 (`updateTalking`)
**Where:** §5 UPDATE, lines 698–725 (`updateDialogue`)
**Where:** §5 UPDATE, lines 729–733 (`giveItemToNpc`)
...
**Where:** §3 STATE, lines 454–458 (`state.flags`)
**Where:** §2 DATA, lines 280–284 (`quests`)
**Where:** §5 UPDATE, lines 560–571 (`update`)
**Where:** §7 RENDER, lines 953–992 (`drawHud`)
