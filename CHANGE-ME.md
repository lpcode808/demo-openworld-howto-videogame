...
**Where:** §1 CONFIG, line 234 (`playerStepsPerSecond`)
...
**Where:** §2 DATA, lines 513–523 (`items`)
...
**Where:** §2 DATA, lines 548–698 (`npcs`)
...
**Where:** §2 DATA, lines 548–698 (`npcs`)
**Where:** §3 STATE, lines 731–777 (`state`)
**Where:** §5 UPDATE, lines 892–912 (`update`)
...
map row.
**Where:** §1 CONFIG, lines 264–288 (`colors`)
**Where:** §2 DATA, lines 365–378 (`tileTypes`)
**Where:** §2 DATA, lines 394–457 (`maps.overworld.rows`)
...
**Where:** §2 DATA, lines 391–479 (`maps`)
**Where:** §2 DATA, lines 394–457 (`maps.overworld.rows`)
**Where:** §2 DATA, lines 482–502 (`doors`)
...
**Where:** §2 DATA, lines 530–535 (`quests`)
**Where:** §2 DATA, lines 548–698 (`npcs`)
**Where:** §5 UPDATE, lines 1078–1093 (`updateTalking`)
**Where:** §5 UPDATE, lines 1097–1134 (`updateDialogue`)
**Where:** §5 UPDATE, lines 1130–1143 (`giveItemsToNpc`)
...
**Where:** §3 STATE, lines 753–758 (`state.flags`)
**Where:** §2 DATA, lines 530–535 (`quests`)
**Where:** §5 UPDATE, lines 892–912 (`update`)
**Where:** §7 RENDER, lines 1396–1458 (`drawHud`) and lines 1463–1477 (`drawQuestList`)
...
**Where:** §2 DATA, lines 548–698 (`npcs`) — the `lines:` arrays inside each `dialogue:` block
...
**Where:** §2 DATA, lines 391–479 (`maps`), lines 482–502 (`doors`), lines 513–523 (`items`),
lines 530–535 (`quests`), lines 548–698 (`npcs`); §6 COLLIDE for the new gate; §1 CONFIG for
