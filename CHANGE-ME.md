...
**Where:** §1 CONFIG, line 219 (`playerStepsPerSecond`)
...
**Where:** §2 DATA, lines 412–417 (`items`)
...
**Where:** §2 DATA, lines 433–543 (`npcs`)
...
**Where:** §2 DATA, lines 433–543 (`npcs`)
**Where:** §3 STATE, lines 576–611 (`state`)
**Where:** §5 UPDATE, lines 702–713 (`update`)
...
map row.
**Where:** §1 CONFIG, lines 242–263 (`colors`)
**Where:** §2 DATA, lines 314–323 (`tileTypes`)
**Where:** §2 DATA, lines 335–367 (`maps.overworld.rows`)
...
**Where:** §2 DATA, lines 332–389 (`maps`)
**Where:** §2 DATA, lines 335–367 (`maps.overworld.rows`)
**Where:** §2 DATA, lines 392–401 (`doors`)
...
**Where:** §2 DATA, lines 421–425 (`quests`)
**Where:** §2 DATA, lines 433–543 (`npcs`)
**Where:** §5 UPDATE, lines 821–836 (`updateTalking`)
**Where:** §5 UPDATE, lines 840–873 (`updateDialogue`)
**Where:** §5 UPDATE, lines 871–875 (`giveItemToNpc`)
...
**Where:** §3 STATE, lines 595–600 (`state.flags`)
**Where:** §2 DATA, lines 421–425 (`quests`)
**Where:** §5 UPDATE, lines 702–713 (`update`)
**Where:** §7 RENDER, lines 1095–1136 (`drawHud`)
